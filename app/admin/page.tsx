...
import { mockShipments, shipmentsByMonth, priorityData, vehicleData } from '@/lib/mockData'
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-7">
        ...
        <div className="flex items-start justify-between mb-7">
          <div>
            ...
            <p className="text-zinc-500 mt-1 text-sm">Real-time fleet overview & AI intelligence</p>
          </div>
          {/* Top-level KPIs */}
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <StatCard
            ...
            icon={<Activity size={16} className="text-brand-yellow" />}
            accent
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-5 card">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="w-7 h-7 bg-zinc-100 rounded-lg flex items-center justify-center hover:bg-zinc-200 transition-all">
            ...
            <div className="flex gap-4 mt-2">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-zinc-500">Delayed</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-4 card">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs bg-red-100 text-red-600 font-semibold px-2 py-0.5 rounded-full">
                {delayed + highRisk} active
              </span>
            </div>
            <div className="space-y-3">
              {shipments
                .filter(s => s.status === 'delayed' || s.delay_risk === 'high')
                .slice(0, 4)
                .map(s => (
                  <div
                    key={s.id}
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-500 mt-0.5">
                      {s.source} → {s.destination} delivered successfully
                    </p>
                  </div>
                </div>
              ))}
